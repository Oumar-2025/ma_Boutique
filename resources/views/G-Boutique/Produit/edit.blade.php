                ...
                @method('PUT')
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <select name="categorie_id" class="form-select" id="">
                                ...
                                @foreach ($categories as $categorie)
                                    <option value="{{ $categorie->id }}" {{ $produit->categorie_id == $categorie->id ? 'selected' : '' }}>{{ $categorie->nom }}
                                    </option>
                                @endforeach
                            </select>
                            @error('categorie')
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="file" name="image" value="{{ old('image', $produit->image) }}" class="form-control @error('image') is-invalid @enderror"
                                id="image">
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" step="1" min="0" value="{{ old('prix_achat', $produit->prix_achat) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" step="1" min="0" name="prix_vente"
                                value="{{ old('prix_vente', $produit->prix_vente) }}" class="form-control" id="iA">
                        </div>
                        <div class="col-md-4">
                            <label for="iB" class="form-label">Stock</label>
                            <input type="number" step="1" min="0" name="stock" value="{{ old('stock', $produit->stock) }}"
