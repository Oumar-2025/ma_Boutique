    ...
    <div class="container-fluid px-4">
        ...
        <div class="card">
            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                <h5 style="color:white;">Modifier un employé</h5>
                ...
                <form action="{{ route('employes.update', $employe->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="prenom" value="{{ old('prenom', $employe->prenom) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nom" value="{{ old('nom', $employe->nom) }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="email" value="{{ old('email', $employe->email) }}" name="email" class="form-control @error('email') is-invalid @enderror"
                                id="iE">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="poste" value="{{ old('poste', $employe->poste) }}" class="form-control @error('poste') is-invalid @enderror"
                                id="iA">
                                 @error('poste')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" step="1" min="0" name="salaire" value="{{ old('salaire', $employe->salaire) }}" class="form-control @error('salaire') is-invalid @enderror"
                                id="iS">
                                @error('salaire')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" value="{{ old('nomurg', $employe->nomurg) }}" name="nomurg"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" value="{{ old('telurg', $employe->telurg) }}" name="telurg"
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="relation" id="iR"
                                ...
                                <option value="Parent" {{ old('relation', $employe->relation) == 'Parent' ? 'selected' : '' }}>Parent</option>
                                <option value="Oncle" {{ old('relation', $employe->relation) == 'Oncle' ? 'selected' : '' }}>Oncle</option>
                                <option value="Tante" {{ old('relation', $employe->relation) == 'Tante' ? 'selected' : '' }}>Tante</option>
                                <option value="Ami(e)" {{ old('relation', $employe->relation) == 'Ami(e)' ? 'selected' : '' }}>Ami(e)</option>
                                <option value="Autre" {{ old('relation', $employe->relation) == 'Autre' ? 'selected' : '' }}>Autre</option>
