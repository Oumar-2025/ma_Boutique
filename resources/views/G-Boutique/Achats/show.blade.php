    ...
    <div class="container-fluid px-4">
        ...
        <div class="card">
            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                <h5 style="color:white;">Détails de l'achat du : {{ $achat->date_achat }}</h5>
            ...
            <div class="card-body px-4 py-3">
                ...
                <p>{{ $achat->fournisseur->prenom }} {{ $achat->fournisseur->nom }}</p>
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="editDetailModal{{ $detail->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <form
                                                action="{{ route('detail-achat.update',  $detail->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                    ...
                                    <div class="modal fade" id="deleteDetailModal{{ $detail->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <form
                                                action="{{ route('detail-achat.delete',  $detail->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <div class="modal-content">
