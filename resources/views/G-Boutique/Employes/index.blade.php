    ...
    <div class="container-fluid px-4"><br>
        ...
        <div class="card">
            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                <h5 style="color:white;">Employés</h5>
                <a href="{{ route('employes.create') }}" class="btn btn-outline-light btn-sm"><i class="fas fa-plus"></i> Ajouter</a>
            </div>
                    ...
                    <tbody>
                        @forelse ($employes as $employe)
                            <tr class="text-center">
                                ...
                                <td>{{ $employe->poste }}</td>
                                <td>
                                    <a href="{{ route('employes.show', $employe->id) }}" class="btn btn-link">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('employes.edit', $employe->id) }}" class="btn btn-link">
                                    ...
                                    <div class="modal fade" id="deleteModal{{ $employe->id }}" tabindex="-1"
                                        aria-labelledby="deleteModalLabel{{ $employe->id }}" aria-hidden="true">
